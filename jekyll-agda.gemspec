require_relative 'lib/jekyll/agda/version'

GH_URL = "https://github.com/paolobrasolin/jekyll-agda"

Gem::Specification.new do |spec|
  spec.name          = "jekyll-agda"
  spec.version       = Jekyll::Agda::VERSION
  spec.authors       = ["Paolo Brasolin"]
  spec.email         = ["paolo.brasolin@gmail.com"]

  spec.summary       = %q{Jekyll plugin to produce browsable literate Agda}
  # spec.description   = ""
